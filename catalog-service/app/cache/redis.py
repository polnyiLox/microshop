...
class RedisCache(Cache):
    """Small fault-tolerant wrapper around the Redis transport."""
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            await client.aclose()
            logger.warning("Redis is unavailable; requests will use PostgreSQL")
        else:
            self._client = client
    ...
    async def get(self, key: str) -> str | None:
        ...
        try:
            ...
            logger.warning("Failed to read from Redis")
            return None
    ...
    async def set(self, key: str, value: str, ttl_seconds: int) -> None:
        ...
        try:
            ...
            logger.warning("Failed to write to Redis")
    ...
    async def delete(self, *keys: str) -> None:
        ...
        try:
            ...
            logger.warning("Failed to invalidate Redis keys")
