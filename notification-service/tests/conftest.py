...
os.environ.update({
    ...
    "APP_CONFIG__API__PORT": "8004",
    "APP_CONFIG__API__RELOAD": "false",
    "APP_CONFIG__RABBITMQ__USER": "test",
    "APP_CONFIG__RABBITMQ__PASSWORD": "test",
    "APP_CONFIG__RABBITMQ__HOST": "localhost",
    "APP_CONFIG__RABBITMQ__PORT": "5672",
    "APP_CONFIG__RABBITMQ__VHOST": "/",
})
