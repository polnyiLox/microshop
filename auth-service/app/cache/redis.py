...
class RedisCache(Cache):
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            await client.aclose()
            logger.warning("Redis unavailable; auth-service will use PostgreSQL", exc_info=True)
        else:
            self._client = client
    ...
    def create_balance_key(self, user_id: str) -> str:
        return f"{self._settings.balance_key}{user_id}"
